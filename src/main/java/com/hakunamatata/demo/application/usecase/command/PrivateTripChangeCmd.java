...
public class PrivateTripChangeCmd {
    ...
    public PaymentDto payChangeOrder(String enterpriseId, Long orderId, Long changeId) {
        Payment payment = changeService.payForChange(enterpriseId, orderId, changeId);
